...
PAYMENT_REJECTED_USER = "❌ پرداخت شما توسط مدیریت تأیید نشد. لطفاً جهت پیگیری با پشتیبانی @PingoPingAdmin در ارتباط باشید."
